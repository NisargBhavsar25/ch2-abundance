...
class DataHandler:
    ...
    def display_fits(self, fits_path, x_range=None):
        ...
        # Plot Gaussian models for each element on the same axes
    ...
    def plot_combined_spectrum(self, fits_path, x_range=None, name="", normalize=True):
        """
    ...
    def generate_spectrum(self, energy_range=(0, 27), num_bins=1024):
        """
        ...
        Returns:
            tuple: (energies, intensities) arrays 
