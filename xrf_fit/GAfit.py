        ...
        for k in range(offspring_size[0]):
            ...
            for i, element in enumerate(self.data_handler.elements):
                ...
                if total_fitness_p2 > total_fitness_p1:
                    ...
                    offspring[k, amp_idx] *= (1 + np.random.normal(0, 0.1))
            ...
            mutation_mask = np.random.random(offspring_size[1]) < 0.4  # 10% mutation rate
            mutation = np.random.normal(0, 0.1, offspring_size[1])  # Small variations
